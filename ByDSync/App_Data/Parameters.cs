...
namespace ByDSync.Miscs
{
    public class Parameters
    {
        ...
        public Parameters()
        {
            ...
            uriAPI["GeneralLedger"] = workcenterURI + "Finglau02.svc/Finglau02?$select=C_Fiscyear,C_Chofaccts,C_AddrBusPart,C_BusPartUuid,C_EmployeeUuid,C_CustomCode1,C_AccDocUuid,C_CustomCode2,C_CustomCode3,C_Accdoctype,C_AccDocItUuid,C_LaChangeDate,C_CreationDate,C_PostingDate,C_ProductUuid,C_Glacct,C_Debitcredit,C_GlacctTc,K_Amtlit,K_ValQuantity,K_Amttra,K_Amtcomp,to_ProfitctrUuid/C_Prftctrid,to_ProjTaskUuid/C_ProjectId,to_Glacct/T_Description,C_Oedpartner,C_Accdoctype,C_OedItemTc&$expand=to_ProfitctrUuid,to_ProjTaskUuid,to_Glacct&$format=json";
